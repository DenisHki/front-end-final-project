...
const CustomerList = () => {
  ...
  const [columns] = useState([
    ...
    { field: "streetaddress", sortable: true, filter: true, width: 190 },
  ...
  // Filtering data to export to a CSV file:
  const filteredData = customers.map(({ content, links, ...rest }) => rest);
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ width: "90%", height: 550, margin: "auto" }}
      >
        <AgGridReact
          animateRows={true}
          rowData={customers}
